...
class ConEncoder1(nn.Module):
    ...
    def forward(self, x, get_steps=False):
        ...
        fea = self.lrelu(fea)  #16,32,160,160


        fea = self.conv_second(fea)  #160


        fea_head = F.max_pool2d(fea, 2)  #80#   16,32,80,80



        fea_down2 = self.denoise(fea_head)  # 16,32,160,160
