...
parser.add_argument('--n_threads', type=int, default=0,    #5
...
parser.add_argument('--dir_data', type=str, default='../../LOL', help='dataset dictionary')
parser.add_argument('--data_name', type=str, default='low', help='dataset name')
...
#parser.add_argument('--lowlight_images_path', type=str, default="dataset/ELD/ELD_cano/")
...
parser.add_argument('--milestone', type=int,default=240, help='decay learing rate')
parser.add_argument('--outf', type=str,default="log31", help='path of log files')
parser.add_argument('--resume_training', default=False, help='resume train from a previous checkpoint')
parser.add_argument('--save_every_epochs',type=int,default=1, help='save')
parser.add_argument('--log_dir', default='log31/', help='tensorboard logs')
